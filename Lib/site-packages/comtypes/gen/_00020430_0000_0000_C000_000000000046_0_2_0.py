...
IFontDisp = Font
__all__ = [ 'OLE_YSIZE_CONTAINER', 'FONTNAME', 'LoadPictureConstants',
           'OLE_YPOS_CONTAINER', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_TRISTATE', 'FONTSIZE', 'IPictureDisp',
           'OLE_XPOS_PIXELS', 'Color', 'Picture', 'OLE_XSIZE_PIXELS',
           'OLE_XSIZE_CONTAINER', 'OLE_COLOR', 'IFontDisp',
           'FONTITALIC', 'VgaColor', 'OLE_HANDLE', 'FONTUNDERSCORE',
           'OLE_CANCELBOOL', 'Gray', 'Monochrome',
           'OLE_XPOS_CONTAINER', 'OLE_YPOS_PIXELS', 'Font',
           'Unchecked', 'IPicture', 'OLE_YSIZE_HIMETRIC', 'FONTBOLD',
           'OLE_YSIZE_PIXELS', 'OLE_OPTEXCLUSIVE', 'StdPicture',
           'StdFont', 'Checked', 'OLE_XPOS_HIMETRIC',
